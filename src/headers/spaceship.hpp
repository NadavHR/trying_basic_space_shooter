...
const float X_BOUND = 1.8, Y_BOUND = 1.3, 
            ...
            SHOOT_COOLDOWN_SEC = 0.18, SHOOT_EFFECT_TIME_SEC = 0.16, // SHOOT_EFFECT_TIME_SEC needs to be smaller or equal to SHOOT_COOLDOWN_SEC for an effect to occure
            LASER_SPEED = 90.0, DEFAULT_LIGHT_DISTANCE = 4.0;
class Spaceship {
    private:
